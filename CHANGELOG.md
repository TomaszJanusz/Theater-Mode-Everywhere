...
- Added Settings → Features toggles for YouTube, Vimeo, and Patreon extras (captions, chapters, previews). Theater mode still works on those sites when a toggle is off.
