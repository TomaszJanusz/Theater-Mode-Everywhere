export const FALLBACK_MESSAGES: Record<string, string> = {
  ...
  youtubeIntegrationDescription: 'Captions, chapters, and hover previews on the timeline in theater mode.',
  vimeoIntegrationTitle: 'Vimeo integration',
  vimeoIntegrationDescription: 'Chapter markers and hover previews on the timeline in theater mode.',
  patreonIntegrationTitle: 'Patreon integration',
  patreonIntegrationDescription: 'Captions and hover previews on the timeline in theater mode.',
  twitchIntegrationTitle: 'Twitch integration',
  twitchIntegrationDescription: 'VOD chapters and hover previews on the timeline in theater mode.',
  disneyIntegrationTitle: 'Disney+ integration',
  disneyIntegrationDescription: 'Captions and hover previews on the timeline in theater mode, when the player provides them.',
